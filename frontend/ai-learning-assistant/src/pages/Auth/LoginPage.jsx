...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try{
      ...
      setError(err.message || "Failed to login. Please check credential");
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50'>
      ...
      <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb, transparent_1px)] bg-size-[16px_16px] opacity-30" />
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10 ">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <label htmlFor="" className="block text-xs font-semibold uppercase text-slate-700 tracking-wide">
                Email
              </label>
              <div className="relative group">
                <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-200 ${
                  ...
                  <Mail className='w-5 h-5' strokeWidth={2}></Mail>
                </div>
                ...
                <input 
                  ...
                  className='w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-500 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10 '
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input 
                  ...
                  onBlur={() => setFocusedField(null)}
                  className='w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-lg  font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emerald-500/10 '
                  placeholder='**********'
                />
              </div>
            </div>
