    ...
    <header className="sticky top-0 z-40 w-full h-16 bg-white/80 backdrop-blur-xl border-b border-slate-200/60 ">
        <div className='flex items-center justify-between h-full px-6'>
            ...
            <div className="flex items-center gap-3">
                ...
                {/* user profile */}
                <div className="flex item-center gap-3 pl-3 border-l border-slate-200/60">
                    <div className="flex items-center gap-3 px-3 py-1.5 rounded-xl hover:bg-slate-50 transition-colors duration-200 cursor-pointer group">
                        <div className="w-9 h-9 items-center  rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 flex item-center justify-center text-white shadow-emerald-500/20 group-hover:shadow-lg group-hover:shadow-emerald-500/30 transition-all duration-200">
