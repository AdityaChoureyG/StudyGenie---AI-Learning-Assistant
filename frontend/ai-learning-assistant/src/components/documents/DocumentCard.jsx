...
const DocumentCard = ({
  ...
  return (
    <div onClick={handleNavigate} className='group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify_between cursor-pointer hover:translate-y-1'>
